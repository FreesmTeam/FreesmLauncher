...
QString getCreditsHtml()
{
    ...
    stream << QString("<p>windstone %1</p>\n").arg(getGitHub("notwindstone"));
    stream << QString("<p>hand7s %1</p>\n").arg(getWebsite("https://one.link/s0me1newithhand7s"));
    stream << QString("<p>fractal %1</p>\n").arg(getWebsite("https://bio.nebula-nook.ru/"));
    stream << QString("<p>so5iso4ka %1</p>\n").arg(getGitHub("so5iso4ka"));
    stream << "<br />\n";
...
{
    QFile dataFile(":/documents/docs/COPYING.md");
