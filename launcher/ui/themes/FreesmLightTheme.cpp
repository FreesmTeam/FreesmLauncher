...
QString FreesmLightTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #ffffff;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "255, 8);}QToolButton::menu-button {background: rgba(255,255,255,0%);border: none;}QMenuBar {background-color: transparent;color: "
           ...
           "5);}QSpinBox::down-button {image: url(theme:SpinBoxDown.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(0, 0, "
           ...
           "5);}QDateTimeEdit::down-button {image: url(theme:SpinBoxDown.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(0, "
           "255, 255, 255);border-radius: 4px;margin-top: 1px;margin-bottom: 1px;margin-right: 2px;min-width: 25px;max-width: 25px;min-height: "
