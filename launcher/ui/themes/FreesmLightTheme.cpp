...
QString FreesmLightTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #ffffff;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "QObject::tab, QObject::section {outline: 0;selection-color: #ffffff;border-radius: 2px;selection-background-color: rgba(215, "
           ...
           "{background-color: rgba(215, 130, 126, 18);border-radius: 5px;color: #ffffff;padding: 7px 20px;margin-right: 5px;border: 1px "
