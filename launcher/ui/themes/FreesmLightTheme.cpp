...
QString FreesmLightTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #ffffff;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "QObject::tab, QObject::section {outline: 0;selection-color: #000000;border-radius: 2px;selection-background-color: rgba(215, "
           "130, 126, 200);alternate-background-color: transparent;}QObject::handle {margin: 2px;background: rgb(215, 130, "
           ...
           "0, 0, 0);border: 1px solid transparent;border-radius: 6px;padding: 2px;margin-left: 8px;}QToolButton[popupMode=\"2\"] "
           ...
           "8);color: #000000;}QToolButton::menu-indicator {image: url(theme:ComboBox.png);width: 32px;height: "
           "38px;}QToolButton::menu-arrow {image: url(theme:ComboBox.png);width: 20px;height: 100%;border-left: 1px solid rgba(0, 0, "
           "0, 8);}QToolButton::menu-button {background: rgba(255,255,255,0%);border: none;}QMenuBar {background-color: transparent;color: "
           ...
           "url(theme:SpinBoxUp.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(255, 255, 255, 0);border-radius: 4px;margin-top: "
           ...
           "5);}QSpinBox::down-button {image: url(theme:SpinBoxDown.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(255, 255, "
           "255, 0);border-radius: 4px;margin-top: 1px;margin-bottom: 1px;margin-right: 3px;min-width: 25px;max-width: 25px;min-height: "
           ...
           "url(theme:SpinBoxDownDisabled.png);}QDoubleSpinBox {background-color: rgba(255, 255, 255, 10);border: 1px solid rgba(0, 0, "
           ...
           "rgba(255, 255, 255, 13);color: rgba(0, 0, 0, 200);border-bottom: 2px solid #d7827e;}QDoubleSpinBox::up-button {image: "
           "url(theme:SpinBoxUp.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(255, 255, 255, 0);border-radius: 4px;margin-top: "
           ...
           "5);}QDoubleSpinBox::down-button {image: url(theme:SpinBoxDown.png);background-color: rgba(255, 255, 255, 0);border: 1px solid "
           ...
           "url(theme:SpinBoxDownDisabled.png);}QDateTimeEdit {background-color: rgba(255, 255, 255, 10);border: 1px solid rgba(0, 0, "
           ...
           "5);}QDateTimeEdit::down-button {image: url(theme:SpinBoxDown.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(40, "
           "105, 131, 255);border-radius: 4px;margin-top: 1px;margin-bottom: 1px;margin-right: 2px;min-width: 25px;max-width: 25px;min-height: "
           ...
           "0, 0, 5);}QDateTimeEdit::up-button:disabled {image: url(theme:SpinBoxUpDisabled.png);}QDateTimeEdit::down-button:disabled "
           ...
           "0, 0, 13);}QComboBox::down-arrow:disabled {image: url(theme:ComboBoxDisabled.png);}QComboBox QAbstractItemView "
