...
QString FreesmTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #11111b;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "{background-color: rgba(255, 255, 255, 20);border: 1px solid rgba(255, 255, 255, "
           "10);border-bottom: 1px solid #707070;}QTextEdit:focus, QPlainTextEdit:focus {border-bottom: 1px solid "
           "#cba6f7;background-color: rgba(0, 0, 0, 255);border-top: 1px solid #cba6f7;border-left: 1px solid #cba6f7; "
