...
QString FreesmTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #11111b;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "8);color: #cdd6f4;}QToolButton::menu-indicator {image: url(theme:ComboBox.png);width: 32px;height: "
           ...
           "#d8d8d8;padding: 4px;padding-left: 8px;padding-right: 20px;border-radius: 0;}QHeaderView::section:hover {background-color: "
           ...
           "rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, 5);border-radius: 7px;border-bottom: 1px solid #707070;padding: "
           "5px;}QTextEdit:hover, QPlainTextEdit:hover {background-color: rgba(255, 255, 255, 20);border: 1px solid rgba(255, 255, 255, "
           "10);border-bottom: 1px solid #707070;}QTextEdit:focus, QPlainTextEdit:focus {border-bottom: 2px solid "
           "#cba6f7;background-color: rgba(255, 255, 255, 5);border-top: 1px solid rgba(255, 255, 255, 7);border-left: 1px solid rgba(255, "
           "255, 255, 7);border-right: 1px solid rgba(255, 255, 255, 7);}QTextEdit:disabled, QPlainTextEdit:disabled {color: rgba(150, "
           "150, 150);background-color: rgba(255, 255, 255, 13);border: 1px solid rgba(255, 255, 255, 5);}QLineEdit {background-color: "
           "rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, 5);color: #ffffff;border-radius: 5px;border-bottom: 1px solid "
           "#707070;padding-left: 5px;padding-top: 4px;padding-bottom: 4px;}QLineEdit:hover {background-color: rgba(255, 255, 255, "
           "20);border: 1px solid rgba(255, 255, 255, 10);border-bottom: 1px solid #707070;}QLineEdit:focus {border-bottom: 2px solid "
           "#cba6f7;background-color: rgba(255, 255, 255, 5);border-top: 1px solid rgba(255, 255, 255, 7);border-left: 1px solid rgba(255, "
           ...
           "url(theme:RadioButton.png);}QRadioButton::indicator:checked {background-color: #cba6f7;border: 1px solid #cba6f7;image: "
           ...
           "{background-color: #cba6f7;border: 1px solid #cba6f7;image: url(theme:CheckBox.png);}QGroupBox::indicator:checked:hover, "
           ...
           "#cba6f7;image: url(theme:CheckBoxPressed.png);}QCheckBox::indicator:indeterminate, QGroupBox::indicator:indeterminate, "
           "QTreeView::indicator:indeterminate, QTableView::indicator:indeterminate {background-color: #cba6f7;border: 1px solid "
           "#cba6f7;image: url(theme:CheckBoxInterminate.png);}QCheckBox::indicator:indeterminate:hover, "
           ...
           "#404040;image: url(theme:CheckBoxDisabled.png);}QGroupBox::indicator:disabled, QMenu::indicator:disabled, "
